package org.employeeservice.exception;
...
import org.employeeservice.exception.response.ValidationFailedResponse;
import org.employeeservice.exception.response.ViolationErrors;
...
public class EmployeeServiceExceptionHandler {
    ...
    public ResponseEntity<Object> employeeHasSubordinatesExceptionHandling(EmployeeHasSubordinatesException exception, WebRequest request) {
        return new ResponseEntity<>(new ErrorDetails(LocalDateTime.now(), exception.getMessage(),
    ...
    public ResponseEntity<Object> invalidSupervisorAssignmentExceptionHandling(InvalidSupervisorAssignmentException exception, WebRequest request) {
        return new ResponseEntity<>(new ErrorDetails(LocalDateTime.now(), exception.getMessage(),
                request.getDescription(false), HttpStatus.CONFLICT), HttpStatus.CONFLICT);
    }
